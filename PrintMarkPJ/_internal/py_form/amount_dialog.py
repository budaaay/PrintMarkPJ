...
# Form implementation generated from reading ui file 'C:\Users\budaa\Desktop\dev\printEXE\ui\amount_dialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_2.addWidget(self.btn_del, 0, 3, 2, 1)
        ...
        self.input_amount.setReadOnly(False)
        self.input_amount.setObjectName("input_amount")
        self.gridLayout.addWidget(self.input_amount, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_print, 2, 2, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Ввод количества копий"))
        ...
        self.btn_print.setText(_translate("Dialog", "Печать"))
        self.btn_cancel.setText(_translate("Dialog", "Отмена"))
        self.label.setText(_translate("Dialog", "Введите количество копий для печати:"))
